...
var DateRangerPicker = require('react-bootstrap-daterangepicker')
  ...
  render() {
    ...
    return (
      <div style={{ marginLeft: -20 }}>
        ...
        {this.state.settingChart.show ? <DialogChartSetting tags={tags}
          metrics={this.state.settingChart.metric}
          showDialog={this.showDialog.bind(this) }/> : ''}
        {this.state.expandChart.show ? <DialogChartView 
          chart={this.state.expandChart.chart} tags={tags}
